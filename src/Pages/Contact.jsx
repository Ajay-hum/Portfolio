  ...
  return (
    <div className="pt-20 md:px-8 bg-white">
      <div className="m-8 md:m-14 md:flex">
        <div data-aos="fade-right" data-aos-duration="1000" className="flex flex-col gap-3 p-2 xl:px-16 md:pt-16 md:w-1/2 md:h-[30rem]">
        ...
        <div data-aos="fade-left" data-aos-duration="1000" className="md:w-1/2 lg:p-4 lg:mr-2 max-sm:mt-6 flex md:h-[30rem] items-stretch">
          <img src={profile} alt="photo" className="w-full h-full object-cover items items-stretch"/>
        </div>
      </div>
      <div data-aos="fade-up" data-aos-duration="1500" className="mt-10 h-1/4 md:h-1/3 flex items-center justify-center w-full shadow-xl">
        <ContactForm />
      </div>
    </div>
  );
